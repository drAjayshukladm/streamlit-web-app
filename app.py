...
def main():
    ...
    if weight > 0 and height > 0:
        ...
        # Call bmi_chart only if weight and height are valid
        bmi_chart(weight, height)
    else:
        st.warning("Please enter valid weight and height values to display the BMI chart.")
